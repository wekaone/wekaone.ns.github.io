...
function init() {
    ...
    myMap.geoObjects
        ...
        balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Наша Школа на 1200 мест</a><br>' +
        ...
        '<b><a href = "#popup:stepform-yandex-maps" target="_blank" style="font-size: 14px">➥ <u>Скачать презентацию</u></a></b>',
        ...
        .add(new ymaps.Placemark([53.3039644252431,50.271267478849275], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Школа №33</a><br>' +
            '<span class="description">Общеобразовательная школа</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.29704862926469,50.279900161079155], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Школа №122</a><br>' +
            '<span class="description">Общеобразовательная школа</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.29701018412871,50.289835955217676], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Школа №156</a><br>' +
            '<span class="description">Общеобразовательная школа</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.300152670838074,50.283937147051596], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Школа №103</a><br>' +
            '<span class="description">Общеобразовательная школа</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.31768183462463,50.31464372525729], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Школа №7</a><br>' +
            '<span class="description">Общеобразовательная школа</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.30341918338826,50.268387447180835], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский №257 «Теремок»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.30139471246428,50.27647698956973], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский №411 «Сказка»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.299479409929845,50.279373775305814], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский №208 «Колобок»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.297679718161554,50.28272117215643], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский №33</a><br>' +
            '<span class="description">Детский сад комбинированного вида</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.30093453029044,50.290977936643024], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский №325 «Незабудка»</a><br>' +
            '<span class="description">Детский сад общеразвивающего вида</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.31034723469309,50.28902048795013], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский №362</a><br>' +
        ...
        .add(new ymaps.Placemark([53.310955899057575,50.301117889899345], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский «Босоногое Счастье»</a><br>' +
            '<span class="description">Частный детский сад</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.31566748507769,50.28582086081487], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский «Львёнок»</a><br>' +
            '<span class="description">Частный детский сад</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.31060902416635,50.316804858575225], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский №2</a><br>' +
            '<span class="description">Детский сад комбинированного вида</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.31505927792369,50.31238974412566], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский №1, Корпус №3</a><br>' +
            '<span class="description">Детский сад комбинированного вида</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.317224440441194,50.31291545709255], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский №1</a><br>' +
            '<span class="description">Детский сад комбинированного вида</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.3137703887794,50.309306071089246], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский «Непоседы»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.31641672677081,50.31301649279916], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский «Детки Конфетки»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.32032281868711,50.306854229768874], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский «Кузя»</a><br>' +
            '<span class="description">Частный детский сад</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.32226928964762,50.308527834912525], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский «Радуга»</a><br>' +
            '<span class="description">Частный детский сад. Центр развития ребёнка</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.32259498269232,50.31174645626422], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детский №1, Корпус №1</a><br>' +
            '<span class="description">Детский сад комбинированного вида</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.303362461127776,50.2798030253827], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Городская больница № 7, Детское<br> поликлиническое отделение № 2</a><br>' +
        ...
        .add(new ymaps.Placemark([53.3028949126879,50.28600373710655], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Детская поликлиника ГБУЗ СО <br>Самарская городская больница №7</a><br>' +
            '<span class="description">Детская поликлиника</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.29938418842678,50.27770083767108], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">ГКБ № 7, стоматологическое отделение</a><br>' +
        ...
        .add(new ymaps.Placemark([53.32128425785829,50.314562965995016], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Городская поликлиника № 1</a><br>' +
        ...
        .add(new ymaps.Placemark([53.300486496013,50.28235063553086], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Сквер «Октябрь»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.31745649165346,50.2857275727237], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Парк-отель «Озерки»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.297428838384675,50.33931165879544], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Лес «Дубовый Гай»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.32168619047387,50.3451083433697], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">«Рассветовский лес»</a><br>' +
            '<span class="description">Лесной массив</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.30222933385242,50.2780403357986], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">ТЦ «Радуга»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.31593470255241,50.302893497533496], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">ТЦ «Мир»</a><br>' +
            '<span class="description">Торговый центр</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.32720491289547,50.30539270347078], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">ТЦ «МЕГА»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.30617868003169,50.27784679074219], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Ледовая арена «Салют»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.31011407061692,50.289889785230834], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Ледовый дворец «Кристалл»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.30769577202182,50.28933404604394], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Имидж-студия Анастасии <br>Худорожковой</a><br>' +
        ...
        .add(new ymaps.Placemark([53.30758801325267,50.28678170889098], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Ваш парикмахер - мужской салон</a><br>' +
        ...
        .add(new ymaps.Placemark([53.308416973136666,50.28578392713746], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Cherry bar Lash&Brow</a><br>' +
        ...
        .add(new ymaps.Placemark([53.30920414875362,50.28747908323487], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Салон красоты Olivia</a><br>' +
            '<span class="description">Салон красоты</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.3099500995024,50.2890177197446], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">WoMan</a><br>' +
            '<span class="description">Салон красоты</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.30980411713804,50.28669285329201], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Марафет</a><br>' +
        ...
        .add(new ymaps.Placemark([53.30945025558656,50.2876958849099], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Аптека ВИТА Экспресс</a><br>' +
        ...
        .add(new ymaps.Placemark([53.30850069944099,50.2885433629653], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Апрель</a><br>' +
            '<span class="description">Аптека</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.30830149389576,50.286885757794074], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Алия</a><br>' +
            '<span class="description">Аптека</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.307215312364114,50.28521008994356], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Магнит-Космети»</a><br>' +
        ...
        .add(new ymaps.Placemark([53.30887160126122,50.28994850272649], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Пятёрочка</a><br>' +
            '<span class="description">Супермаркет</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.30762227406958,50.28520748239481], {
            // Зададим содержимое заголовка балуна.
            balloonContentHeader: '<a href = "#popup:stepform-yandex-maps" target="_blank">Магнит</a><br>' +
            '<span class="description">Супермаркет</span>',
            // Зададим содержимое основной части балуна.
        ...
        .add(new ymaps.Placemark([53.30704688152192,50.28914832598631], {
            ...
            '<span class="description">ООО "СЗ "ФИНСТРОЙ"<br><br><i>Режим работы:</i><br>пн-пт с 09 до 19<br>сб-вс с 09 до 16<br><br><i>Адрес:</i><br><a href="https://yandex.ru/maps/51/samara/?ll=50.289406%2C53.307253&mode=poi&poi%5Bpoint%5D=50.289373%2C53.307363&poi%5Buri%5D=ymapsbm1%3A%2F%2Forg%3Foid%3D2999599358&z=21">г. Самара, Красноглинский р-н, <br>поселок Мехзавод 1- й квартал, д. 40</a></span>',
            // Зададим содержимое основной части балуна.
